function [Y,p] = getYukawaInt_ND_powerexp(r,ND,m,k,rCap_fit,N_int_cut,varargin)
...
if length(varargin) >= 3
    showPowerexp = varargin{3};
end
showYukawaint = false;
if length(varargin) >= 4
    showYukawaint = varargin{4};
end
% 
% fprintf('rCap_fit = %e\n',rCap_fit)
% fprintf('Nmin_int = %u\n',Nmin_int)
